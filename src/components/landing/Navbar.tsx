    ...
    <div className="fixed top-4 left-0 right-0 z-50 px-4 sm:px-6">
      <nav
        className={`max-w-[1200px] mx-auto rounded-2xl transition-all duration-400 px-4 sm:px-6 ${
          scrolled
            ? "bg-[rgba(10,5,16,0.75)] border border-purple-500/20 py-2.5"
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3 items-center">
            <a href="#metricas" className="hidden sm:inline-flex border border-white/10 bg-transparent text-slate-50 text-xs px-5 py-2 rounded-full font-medium hover:border-purple-500/50 transition-all">
              Dashboard
            </a>
