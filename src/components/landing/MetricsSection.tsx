    ...
    <RevealSection className="max-w-[1000px] mx-auto px-5 sm:px-[5%]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
        <motion.div
          ...
          className="bg-white border border-slate-200 rounded-xl p-6 sm:p-8 text-center shadow-sm"
        >
        ...
        <motion.div
          ...
          style={{ transformPerspective: 1000 }}
          className="col-span-2 sm:col-span-1 bg-white border border-slate-200 rounded-xl p-6 sm:p-8 text-center shadow-sm"
        >
          <h3 className="font-space text-3xl sm:text-4xl font-bold text-orange-500 leading-none mb-1 tabular-nums">
        ...
        <motion.div
          ...
          className="col-span-2 sm:col-span-3 bg-white border border-slate-200 rounded-xl p-6 sm:p-8 shadow-sm"
        >
