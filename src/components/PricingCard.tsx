        ...
        >
          ...
          <div className="relative rounded-3xl border-2 border-emerald/50 bg-card overflow-hidden pulse-glow">
            ...
            <div className="p-8 md:p-10">
              ...
              <Button 
                size="lg" 
                className="w-full h-12 sm:h-14 text-sm sm:text-lg font-bold bg-emerald hover:bg-emerald-glow text-background transition-all duration-300 group"
              >
