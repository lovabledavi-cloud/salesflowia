      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Tire suas dúvidas sobre o SalesFlow 360
          </p>
        </motion.div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="border border-border rounded-xl px-6 bg-card/50 backdrop-blur-sm data-[state=open]:border-violet/50 transition-colors"
              >
