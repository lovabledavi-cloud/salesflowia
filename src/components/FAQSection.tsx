  ...
  return <section className="py-20 px-4 relative">
      <div className="container">
        ...
        once: true
          ...
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet/20 text-violet text-sm font-medium mb-4">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">Tire suas dúvidas sobre o SalesFlowIA</p>
        </motion.div>
        ...
        once: true
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border border-border rounded-xl px-6 bg-card/50 backdrop-blur-sm data-[state=open]:border-violet/50 transition-colors">
