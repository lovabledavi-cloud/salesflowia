      ...
      <div className="relative">
        ...
        <div className="flex mb-6 animate-scroll-left">
          {duplicatedTestimonials.map((testimonial, index) => (
            <div
              key={`row1-${index}`}
              className="flex-shrink-0 w-[350px] mx-3 p-6 rounded-2xl border border-border bg-card/80 backdrop-blur-sm hover:border-violet/50 transition-colors duration-300"
            >
        ...
        <div className="flex animate-scroll-right">
          {duplicatedTestimonials.reverse().map((testimonial, index) => (
            <div
              key={`row2-${index}`}
              className="flex-shrink-0 w-[350px] mx-3 p-6 rounded-2xl border border-border bg-card/80 backdrop-blur-sm hover:border-emerald/50 transition-colors duration-300"
            >
              <div className="flex items-center gap-4 mb-4">
